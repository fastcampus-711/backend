...
public class MenuInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        memberRepository.save(Member.of("user", passwordEncoder().encode("tempPassword12!@"), List.of(MemberRole.USER)));
        memberRepository.save(Member.of("admin", passwordEncoder().encode("tempPassword12!@"), List.of(MemberRole.USER, MemberRole.ADMIN)));
